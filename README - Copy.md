...
Welcome to the AI PC Application Installer. This application is specifically designed to facilitate the setup of development tools, apps and environments for Intel AIPC developer engagements and events. It leverages Microsoft package manager (winget) and also supports external application download/install workflows with JSON-based configuration.
...
- **Linux Installer Documentation**: [Linux_Software_Installation/README.md](./Linux_Software_Installation/README.md)
