<#
.SYNOPSIS
    EULA acceptance dialog (WinForms).

.DESCRIPTION
    Displays a legal disclaimer dialog requiring the user to acknowledge
    license agreements. Returns $true if accepted, $false otherwise.
    Wrapped in a function so it can be called without terminating the session.
#>
...
'@
    ...
    $box.ClientSize      = New-Object System.Drawing.Size(600, 380)
    ...
    $label.Size     = New-Object System.Drawing.Size(450, 260)
    $label.Text     = $disclaimer
    $label.Font     = New-Object System.Drawing.Font("Arial", 10)
    $label.AutoSize = $true
    $label.Padding  = New-Object System.Windows.Forms.Padding(10, 10, 10, 10)

    $alink              = New-Object System.Windows.Forms.LinkLabel
    $alink.Text         = "Click here for the list of applications and their corresponding EULA"
    $alink.Location     = New-Object System.Drawing.Point(10, 280)
    $alink.Size         = New-Object System.Drawing.Size(580, 20)
    $alink.LinkBehavior = [System.Windows.Forms.LinkBehavior]::AlwaysUnderline
    $alink.Font         = New-Object System.Drawing.Font("Arial", 10)
    $alink.Add_Click({
    ...
    $check_box.Location = New-Object System.Drawing.Point(10, 250)

    $check_the_box          = New-Object System.Windows.Forms.Label
    $check_the_box.Location = New-Object System.Drawing.Point(10, 230)
    ...
    $accept_button           = New-Object System.Windows.Forms.Button
    $accept_button.Location  = New-Object System.Drawing.Point(150, 310)
    $accept_button.Size      = New-Object System.Drawing.Size(150, 45)
    $accept_button.Text      = "Agree and Continue"
    $accept_button.Font      = New-Object System.Drawing.Font("Arial", 12)
    ...
    $disagree_button           = New-Object System.Windows.Forms.Button
    $disagree_button.Location  = New-Object System.Drawing.Point(310, 310)
    $disagree_button.Size      = New-Object System.Drawing.Size(150, 45)
    $disagree_button.Text      = "Do not accept"
    $disagree_button.Font      = New-Object System.Drawing.Font("Arial", 12)
    ...
    # Return a boolean — no exit calls
    return ($box.DialogResult -eq [System.Windows.Forms.DialogResult]::OK)
}
